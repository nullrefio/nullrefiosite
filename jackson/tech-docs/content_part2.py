...
<tr><td><code>Parsing</code></td><td>The parsing engine (~19 section parsers, dictionaries, OCR fallback)</td><td>DocumentConversion</td></tr>
...
<code>Parse&lt;Section&gt;()</code> methods plus dictionary/regex license finders extract structured data.</li>
</ol>
